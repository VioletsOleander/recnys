...
Recnys supports dry-run mode. In this mode, no actual file operations will be performed, but the actions that would be executed will be printed to the console. If there will be any issues with synchronization, they will be printed to the console as well.
